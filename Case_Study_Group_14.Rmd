...
Einzelteil_T21$origin<-as.Date(Einzelteil_T21$origin,format = "%d-%m-%Y")
Einzelteil_T21<- mutate(Einzelteil_T21,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
...
Einzelteil_T25$origin<-as.Date(Einzelteil_T25$origin,format = "%d-%m-%Y")
Einzelteil_T25<- mutate(Einzelteil_T25,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
...
Einzelteil_T26$origin<-as.Date(Einzelteil_T26$origin,format = "%d-%m-%Y")
Einzelteil_T26<- mutate(Einzelteil_T26,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
...
Einzelteil_T33$origin<-as.Date(Einzelteil_T33$origin,format = "%d-%m-%Y")
Einzelteil_T33<- mutate(Einzelteil_T33,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
...
Einzelteil_T37$origin<-as.Date(Einzelteil_T37$origin,format = "%d-%m-%Y")
Einzelteil_T37<- mutate(Einzelteil_T37,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
...
Einzelteil_T40$origin<-as.Date(Einzelteil_T40$origin,format = "%d-%m-%Y")
Einzelteil_T40<- mutate(Einzelteil_T40,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
  

#Einzelteil_T39<-read_file('Data/Einzelteil/Einzelteil_T39.txt') %>% str_replace_all(pattern = '"',replacement = "")%>% str_split(pattern='\a')
#Einzelteil_T39<-separate(Einzelteil_T39 ,col=1,sep = "\\\\",into=c('X','X1','ID_T39','Produktionsdatum','Herstellernummer','Werksnummer','Fehlerhaft','Fehlerhaft_Datum','Fehlerhaft_Fahrleistung')) %>% select(3:9)
...
Einzelteil_T36$Origin<-as.Date(Einzelteil_T36$Origin,format = "%d-%m-%Y")
Einzelteil_T36<- mutate(Einzelteil_T36,Produktionsdatum = (Origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-Origin))
...
Einzelteil_T34$Origin<-as.Date(Einzelteil_T34$Origin,format = "%d-%m-%Y")
Einzelteil_T34<- mutate(Einzelteil_T34,Produktionsdatum = (Origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-Origin))
...
Einzelteil_T31$Origin<-as.Date(Einzelteil_T31$Origin,format = "%d-%m-%Y")
Einzelteil_T31<- mutate(Einzelteil_T31,Produktionsdatum = (Origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-Origin))
...
Einzelteil_T27$origin <- as.Date(Einzelteil_T27$origin,format = "%d-%m-%Y")
Einzelteil_T27<- mutate(Einzelteil_T27,Produktionsdatum = (origin+Produktionsdatum_Origin))%>% select(c(-Produktionsdatum_Origin,-origin))
